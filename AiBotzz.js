...
const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `6281999042372-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': global.thumb, thumbnail: global.thumb,sendEphemeral: true}}}
const memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 1000000000, status: 1, thumbnail: await Al.reSize(await getBuffer('https://telegra.ph/file/e20877bca4eae038cb001.jpg'),300,150), surface: 1, message: '𝙁𝙪𝙧𝙞𝙣𝙖 𝙈𝘿 💙', orderTitle: ``, sellerJid: '0@s.whatsapp.net' } } }
...
const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `𝙁𝙪𝙧𝙞𝙣𝙖 𝙈𝘿 💙`,thumbnailUrl: global.thumb}}}
...
const ftoko = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})}, message: {productMessage: {product: {productImage:{mimetype: `image/jpeg`, thumbnailUrl: `${global.thumb}`}, title: `𝙁𝙪𝙧𝙞𝙣𝙖 𝙈𝘿 💙`, description: `${namabot}`, currencyCode: `IDR`, priceAmount1000: 1000000000, retailerId: `Ghost`, productImageCount: 1}, businessOwnerJid: `0@s.whatsapp.net`}}}
...
forwardedNewsletterMessageInfo: {
	newsletterName: "🙌 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝙄𝙣𝙛𝙤 𝙁𝙪𝙧𝙞𝙣𝙖-𝙈𝘿 💙",
		newsletterJid: "120363303523598762@newsletter",
		},
		externalAdReply: {  
...
if (isResponx) {
if (budy.match('𝙒𝙖𝙣|@Mark|@6281999042372||@mark|𝙒𝙖𝙣|𝙒𝙖𝙣|𝙒𝙖𝙣')) {
...
Al.sendMessage('6281999042372@s.whatsapp.net', {text: `*WhatsApp Private Chat*\n\n*From :* ${m.sender.split("@")[0]}\n*Chat :* ${budy}`}, {quoted: fkontak})
}
        ...
        message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
                ...
                nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                    buttons: [{
                                        "name": "quick_reply",
                "buttonParamsJson": `{"display_text":"「 𝗙𝗨𝗥𝗜𝗡𝗔 」","id":"${prefix}allmenu"}`
                },
                {
            "name": "cta_url",
            "buttonParamsJson": "{\"display_text\":\"「 𝗢𝗪𝗡𝗘𝗥 」\",\"url\":\"https://wa.me/+6281999042372?text=Assalamualaikum\",\"merchant_url\":\"https://www.google.com\"}"
},
 ],
 })
 })
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"CHAT OWNER\",\"url\":\"https://wa.me/+6281999042372?text=Halo+Bang\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                "name": "quick_reply",
...
isForwarded: true,
forwardedNewsletterMessageInfo: {
	newsletterName: "𝘾𝙝𝙖𝙣𝙚𝙡 𝙄𝙣𝙛𝙤 𝙁𝙪𝙧𝙞𝙣𝙖-𝙈𝘿 💙",
		newsletterJid: "120363303523598762@newsletter",
		},
		externalAdReply: {  
title: `© 𝙒𝙖𝙣𝘽𝙤𝙩𝙯`, 
...
isForwarded: true,
forwardedNewsletterMessageInfo: {
	newsletterName: "𝘾𝙝𝙖𝙣𝙚𝙡 𝙄𝙣𝙛𝙤 𝙁𝙪𝙧𝙞𝙣𝙖-??𝘿 💙",
		newsletterJid: "120363303523598762@newsletter",
		},
		externalAdReply: {  
title: `© 𝙒𝙖𝙣𝘽𝙤𝙩𝙯`, 
...
isForwarded: true,
forwardedNewsletterMessageInfo: {
	newsletterName: "🙌 𝘾𝙝𝙖𝙣𝙚𝙡 𝙄𝙣??𝙤 𝙁𝙪𝙧𝙞𝙣𝙖-𝙈𝘿 💙",
		newsletterJid: "120363303523598762@newsletter",
		},
		externalAdReply: {  
title: `© 𝙒𝙖𝙣𝘽𝙤𝙩𝙯`, 
...
body: '| ━➤ 𝑾𝒂𝒏𝒏 𝑮𝒂𝒎𝒕𝒆𝒏𝒌',
thumbnailUrl: global.thumb,
sourceUrl: `https://chat.whatsapp.com/D5bzpQmYdQmL2ixDIJr4JY`,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: floc})
}
...
break
case 'ai': case 'openai': {
                if (!q) return m.reply(`*Mau Nanya Apa Sama Furina..?*`)
                m.reply('_Loading..._')
...
mediaUrl: `${sig}`,
//sourceUrl: `${syt}`,
sourceUrl: `https://wa.me/6281999042372?text=Bang+mau+sewa+bot`
}
...
Contoh:
${prefix}nuliskiri 𝙒𝙖𝙣 keren abis`)
break
case'nuliskiri': {
if (!text) return m.reply(`Gunakan dengan cara ${prefix+command} text\n\nContoh : ${prefix+command} 𝙒𝙖𝙣?`)
await Al.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}
  })   
...
title: `𝙒𝙖𝙣? , 𝙁𝙪𝙧𝙞𝙣𝙖-𝙈𝘿 💙`,body:`⌜ Bot MD ⌟`,previewType:"PHOTO",thumbnailUrl: global.thumb,sourceUrl: `${sgc}`,}
...
if (!isRegistered) return terdaftar()
if (isBan) return terbanned()
if (!text) return m.reply(`Example: ${prefix}${command} 𝙒𝙖𝙣𝘽𝙤𝙩𝙯`)
await Al.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
...
let cpu = "30"
let disk = "1024"
let email = username + "@𝙒𝙖𝙣.𝙊𝙛𝙛𝙘𝙞𝙖𝙡"
...
let cpu = "240"
let disk = "2000"
let email = username + "@𝙒𝙖𝙣.𝙊𝙛??𝙘𝙞𝙖𝙡"
akunlo = "https://files.catbox.moe/24p794.mp4" 
if (!u) return
let d = (await Al.onWhatsApp(u.split`@`[0]))[0] || {}
let password = d.exists ? crypto.randomBytes(5).toString('hex') : t[3]
...
break
         case "listusr": {
  if (!isCreator) return m.reply('Malu Anjing Lu Bukan Bg 𝙒𝙖𝙣')
  let page = args[0] ? args[0] : '1';
...
var teks = `*List Bahasa Yang Tersedia Di 𝙒𝙖𝙣𝘽𝙤𝙩𝙯*\n\n`
...
let tod = await getBuffer('https://telegra.ph/file/e20877bca4eae038cb001.jpg') 
let id = m.sender
this.menfes[id] = {
id,
a: m.sender,
...
mediaType:  1,
mediaUrl: 'https://wa.me/6281999042372',
title: `© AiBotzz-MD`,
...
Al.sendMessage('6281999042372@s.whatsapp.net', { text: `Hai Ownerku, Ada laporan nie dari seseorang\n\n*Laporan :* ${text}\n*Dari :* @${m.sender.split('@')[0]}`, mentions: [m.sender]}, { quoted: fkontak})
...
Al.sendMessage('6281999042372@s.whatsapp.net', { text: `Hai Ownerku, Ada yang request nie dari seseorang\n\n*Request :* ${text}\n*Dari :* @${m.sender.split('@')[0]}`, mentions: [m.sender]}, { quoted: fkontak})
...
if (!isRegistered) return terdaftar()
if (isBan) return terbanned()
 if (!text) return m.reply(`Example : ${prefix + command} yunzhie, 7, 7, 2024, 𝙒𝙖𝙣, 16, 11, 2024`)
...
let e = String(err)
Al.sendMessage("6281999042372@s.whatsapp.net", { text: "*NOTIF FOR OWNER*\nAda yang Error Nie\n\n*ERROR/BUG*\n" + util.format(e), 
contextInfo:{
forwardingScore: 1, 
isForwarded: false
}})

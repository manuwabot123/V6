...
const memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 1000000000, status: 1, thumbnail: await Al.reSize(await getBuffer('https://telegra.ph/file/e20877bca4eae038cb001.jpg'),300,150), surface: 1, message: '𝗠𝗔𝗡𝗨 𝙈𝘿 💙', orderTitle: ``, sellerJid: '0@s.whatsapp.net' } } }
...
const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `𝗠𝗔𝗡𝗨 𝙈𝘿 💙`,thumbnailUrl: global.thumb}}}
...
const ftoko = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})}, message: {productMessage: {product: {productImage:{mimetype: `image/jpeg`, thumbnailUrl: `${global.thumb}`}, title: `𝗠𝗔𝗡𝗨 𝙈𝘿 💙`, description: `${namabot}`, currencyCode: `IDR`, priceAmount1000: 1000000000, retailerId: `Ghost`, productImageCount: 1}, businessOwnerJid: `0@s.whatsapp.net`}}}
...
forwardedNewsletterMessageInfo: {
	newsletterName: "🙌 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝙄𝙣𝙛𝙤 𝗠𝗔𝗡𝗨-𝙈𝘿 💙",
...
if (isResponx) {
if (budy.match('𝙒𝙖𝙣|@Mark|@94742274855||@mark|𝙒𝙖𝙣|𝙒𝙖𝙣|𝙒𝙖𝙣')) {
...
title: `𝙒𝙖𝙣? , 𝗠𝗔𝗡𝗨-𝙈𝘿 💙`,body:`⌜ Bot MD ⌟`,previewType:"PHOTO",thumbnailUrl: global.thumb,sourceUrl: `${sgc}`,}
...
if (!isRegistered) return terdaftar()
if (isBan) return terbanned()
if (!q) return m.reply(`wheres the link?`)

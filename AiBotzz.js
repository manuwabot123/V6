...
//Ucapan Waktu #1
if(timeWib < "23:59:00"){ var ucapanWaktu = 'ɢᴏᴏᴅ ɴɪɢʜᴛ'}
if(timeWib < "19:00:00"){ var ucapanWaktu = 'ɢᴏᴏᴅ ɴɪɢʜᴛ'}
if(timeWib < "18:00:00"){ var ucapanWaktu = 'ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ'}
if(timeWib < "15:00:00"){ var ucapanWaktu = 'ɢᴏᴏᴅ ᴀꜰᴛᴇʀɴᴏᴏɴ'}
if(timeWib < "11:00:00"){ var ucapanWaktu = 'ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ'}
if(timeWib < "06:00:00"){ var ucapanWaktu = 'ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ'}     

//Ucapan Waktu #2
if(wibTime < "23:59:00"){ var sopanDong = 'සුභ රාත්‍රියක්'}
if(wibTime < "19:00:00"){ var sopanDong = 'සුභ රාත්‍රියක්'}
if(wibTime < "18:00:00"){ var sopanDong = 'සුභ සන්ධ්‍යාවක්'}
if(wibTime < "15:00:00"){ var sopanDong = 'සුභ සන්ධ්‍යාවක්'}
if(wibTime < "11:00:00"){ var sopanDong = 'සුභ උදෑසනක්'}
if(wibTime < "06:00:00"){ var sopanDong = 'සුභ උදෑසනක්'}    
...
const memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 1000000000, status: 1, thumbnail: await Al.reSize(await getBuffer('https://telegra.ph/file/33e5f1bfd36ea02f8b062.jpg'),300,150), surface: 1, message: '⚖️©𝐌𝐫 𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥👨‍💻', orderTitle: ``, sellerJid: '0@s.whatsapp.net' } } }
const fpay = { key: { remoteJid: '0@s.whatsapp.net', fromMe: false, id:global.namabot, participant: '0@s.whatsapp.net'}, message: { requestPaymentMessage: { currencyCodeIso4217: "IDR", amount1000: 999999999999999, requestFrom: '0@s.whatsapp.net', noteMessage: { extendedTextMessage: { text: 'ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ\nɴᴀᴍᴀ : 𝗠𝗮𝗻𝘂𝗕𝗼𝘁𝘇\nsᴛᴀᴛᴜs : ᴏɴʟɪɴᴇ'}}, expiryTimestamp: 999999999999999, amount: { value: 91929291929, offset: 1000, currencyCode: "IDR"}}}}
...
const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `⚖️©𝐌𝐫 𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥👨‍💻`,thumbnailUrl: global.thumb}}}
...
const ftoko = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})}, message: {productMessage: {product: {productImage:{mimetype: `image/jpeg`, thumbnailUrl: `${global.thumb}`}, title: `⚖️©𝐌𝐫 𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥👨‍💻`, description: `${namabot}`, currencyCode: `IDR`, priceAmount1000: 1000000000, retailerId: `Ghost`, productImageCount: 1}, businessOwnerJid: `0@s.whatsapp.net`}}}
...
forwardedNewsletterMessageInfo: {
	newsletterName: "⚖️©𝐌𝐫 𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥👨‍💻",
		newsletterJid: "120363200175936047@g.us",
		},
		externalAdReply: {  
            showAdAttribution: true,
            title: `⚖️©𝐌𝐫 𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥👨‍💻`,
            body: ``,
            previewType: "VIDEO",
...
const terdaftar = () => {
Al.sendMessage(m.chat, {text: `කරුණාකර ටයිප් කරන්න *${prefix}register* එවිට ඔබට දත්ත සමුදායේ ලියාපදිංචි කළ හැකිය ${global.namabot}\n\n*උදා- :* ${prefix}register Name.Age`}, {quoted: m})
}
...
if (isResponx) {
if (budy.match('𝗠𝗮𝗻𝘂𝗹|@Mark|@94742274855||@mark|𝗠𝗮𝗻𝘂𝗹|𝗠𝗮𝗻𝘂𝗹|𝗠𝗮𝗻𝘂𝗹')) {
...
let ppUrl = await Al.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/83e4f1279c191e8ce52e6.png')
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
                ...
                header: proto.Message.InteractiveMessage.Header.create({
                    ...
                    mimetype: "application/msword",
                        fileLength: 999999999999778866,
                        jpegThumbnail:fs.readFileSync("./Al.jpg"),
                        fileName: "Manu MD - FDOC",
                     }, {
                ...
                nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                    buttons: [{
                                        "name": "quick_reply",
                "buttonParamsJson": `{"display_text":"「 𝗠𝗘𝗡𝗨 」","id":"${prefix}allmenu"}`
                },
                {
            "name": "cta_url",
            "buttonParamsJson": "{\"display_text\":\"「 𝗢𝗪𝗡𝗘𝗥 」\",\"url\":\"https://wa.me/+94742274855?text=Assalamualaikum\",\"merchant_url\":\"https://www.google.com\"}"
},
 ],
 })
 })
...
const uploadFile = { upload: Al.waUploadToServer };
        ...
        const product = {
          ...
          title: `හායි *${pushname}* 👋`,
          description: "ඔබට සොයා ගැනීමට අවශ්‍ය කුමක්ද, සහෝදරයා?",
          currencyCode: "IDR",
...
`+readmore+`
       _❏  𝗠𝗔𝗡𝗨 𝗕𝗢𝗧𝗭  𝙄𝙉𝙁𝙊_
╭─────────────┈┈
⌬〡 _*✨ɴᴀᴍᴇ ʙᴏᴛ🤖*_ 𝐌𝐚𝐧𝐮-𝐌𝐃
⌬〡 _*✨ᴄʀᴇᴀᴛᴏʀ👨‍💻*_  ©𝐌𝐫 𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥
⌬〡︎ _*✨ᴠᴇʀsɪᴏɴs⏳*_ 6.0.1
⌬〡︎ _*✨ᴛʏᴘᴇ sᴄʀɪᴘᴛ🔮*_ 𝐩𝐥𝐮𝐠𝐢𝐧
⌬〡 _*✨ᴡʜᴀᴛꜱᴀᴘᴘ🪀*_ `+94742274855`
╰─────────────┈┈
...
`+readmore+`
 ...
 │ ィ•  ${prefix}🌥️donasi
 │ ィ•  ${prefix}🌥️payment
 │ ィ•  ${prefix}🌥️topup-dana
 │ ィ•  ${prefix}🌥️topup-gopay
 │ ィ•  ${prefix}🌥️topup-ovo
 │ ィ•  ${prefix}🌥️infobot
 │ ィ•  ${prefix}🌥️totalfitur
 │ ィ•  ${prefix}🌥️ownerinfo
 │ ィ•  ${prefix}🌥️botinfo
 │ ィ•  ${prefix}🌥️pulsa
 │ ィ•  ${prefix}🌥️gcbot
 ...
 ┌─────────────┈•∘
 │ ィ•  ${prefix}🌥️quotessad
 │ ィ•  ${prefix}🌥️quotesimage
 │ ィ•  ${prefix}🌥️quotesdilan
 │ ィ•  ${prefix}🌥️quotesislami
 │ ィ•  ${prefix}🌥️quotesjay
 │ ィ•  ${prefix}🌥️pantun
 │ ィ•  ${prefix}🌥️katabijak
 │ ィ•  ${prefix}🌥️motivasi
 ...
 ┌─────────────┈•∘
 │ ィ•  ${prefix}🌥️asahotak
 │ ィ•  ${prefix}🌥️caklontong
 │ ィ•  ${prefix}🌥️family100
 │ ィ•  ${prefix}🌥️kuis
 │ ィ•  ${prefix}🌥️math
 │ ィ•  ${prefix}🌥️siapakahaku
 │ ィ•  ${prefix}🌥️susunkata
 │ ィ•  ${prefix}🌥️tebakanime
 │ ィ•  ${prefix}🌥️tebakbendera
 │ ィ•  ${prefix}🌥️tebakgambar
 │ ィ•  ${prefix}🌥️tebakkalimat
 │ ィ•  ${prefix}🌥️tebakkata
 │ ィ•  ${prefix}🌥️tebakkimia
 │ ィ•  ${prefix}🌥️tebaklagu
 │ ィ•  ${prefix}🌥️tebaklirik
 │ ィ•  ${prefix}🌥️cekkhodam
 │
 ...
 │ ィ•  ${prefix}🌥️artimimpi
 │ ィ•  ${prefix}🌥️cocoknama
 │ ィ•  ${prefix}🌥️cocokpasangan
 │ ィ•  ${prefix}🌥️ramalanjodoh
 │ ィ•  ${prefix}🌥️jadiannikah
 │ ィ•  ${prefix}🌥️sifatusaha
 │ ィ•  ${prefix}🌥️rejeki
 │ ィ•  ${prefix}🌥️pekerjaan
 │ ィ•  ${prefix}🌥️ramalannasib
 │ ィ•  ${prefix}🌥️penyakit
 │ ィ•  ${prefix}🌥️shio
 │ ィ•  ${prefix}🌥️zodiak
 │ ィ•  ${prefix}🌥️memancing
 │ ィ•  ${prefix}🌥️masasubur
 │ ィ•  ${prefix}🌥️keberuntungan
 │ ィ•  ${prefix}🌥️sifat
 │ ィ•  ${prefix}🌥️weton
 │ ィ•  ${prefix}🌥️peruntungan
 │ ィ•  ${prefix}🌥️arahrejeki
 │ ィ•  ${prefix}🌥️nagahari
 │ ィ•  ${prefix}🌥️harinaas
 │ ィ•  ${prefix}🌥️harisangar
 │ ィ•  ${prefix}🌥️haribaik
 │ ィ•  ${prefix}🌥️fengshui
 │ ィ•  ${prefix}🌥️artitarot
 ╵
 ...
 │ ィ•  ${prefix}🌥️menfes
 │ ィ•  ${prefix}🌥️confes
 │ ィ•  ${prefix}🌥️balasmenfes
 │ ィ•  ${prefix}🌥️tolakmenfes
 │ ィ•  ${prefix}🌥️stopmenfes
 ╵
 ...
 │ ィ•  ${prefix}🌥️surah
 │ ィ•  ${prefix}🌥️listsurah
 │ ィ•  ${prefix}🌥️jadwalsholat
 │ ィ•  ${prefix}🌥️asmaulhusna
 │ ィ•  ${prefix}🌥️kisahnabi
 │ ィ•  ${prefix}🌥️quotesislami
 │ ィ•  ${prefix}🌥️hadist
 ╵
 ...
 │ ィ•  ${prefix}🌥️antitoxic
 │ ィ•  ${prefix}🌥️antiwame
 │ ィ•  ${prefix}🌥️antilinkfb
 │ ィ•  ${prefix}🌥️antilinkig
 │ ィ•  ${prefix}🌥️antilinktele
 │ ィ•  ${prefix}🌥️antilinkytch
 │ ィ•  ${prefix}🌥️antilinkytvid
 │ ィ•  ${prefix}🌥️antilinktt
 │ ィ•  ${prefix}🌥️antilinkxxnx
 │ ィ•  ${prefix}🌥️autosticker
 │ ィ•  ${prefix}🌥️autodlgc
 │ ィ•  ${prefix}🌥️antilinkall
 │ ィ•  ${prefix}🌥️antilinktwt
 │ ィ•  ${prefix}🌥️antilinksfile
 │ ィ•  ${prefix}🌥️antilinkdc
 │ ィ•  ${prefix}🌥️antidoc
 │ ィ•  ${prefix}🌥️antiloc
 │ ィ•  ${prefix}🌥️anticon
 │ ィ•  ${prefix}🌥️antivideo
 │ ィ•  ${prefix}🌥️antiaudio
 │ ィ•  ${prefix}🌥️antiteks
 │ ィ•  ${prefix}🌥️antidelete
 │ ィ•  ${prefix}🌥️antivo
 │ ィ•  ${prefix}🌥️antivirtex
 │ ィ•  ${prefix}🌥️myrespon
 ╵
 ...
 ┌─────────────┈•∘
 │ ィ•  ${prefix}🌥️igemoji
 │ ィ•  ${prefix}🌥️iphoneemoji
 │ ィ•  ${prefix}🌥️googleemoji
 │ ィ•  ${prefix}🌥️samsungemoji
 │ ィ•  ${prefix}🌥️microsoftemoji
 │ ィ•  ${prefix}🌥️whatsappemoji
 │ ィ•  ${prefix}🌥️twitteremoji
 │ ィ•  ${prefix}🌥️facebookemoji
 │ ィ•  ${prefix}🌥️skypeemoji
 │ ィ•  ${prefix}🌥️joyemoji
 │ ィ•  ${prefix}🌥️mojiemoji
 │ ィ•  ${prefix}🌥️pediaemoji
 ╵
 ...
 │ ィ•  ${prefix}🌥️bannedv6
 │ ィ•  ${prefix}🌥️bannedv7
 │ ィ•  ${prefix}🌥️unbannedv1
 │ ィ•  ${prefix}🌥️unbannedv2
 │ ィ•  ${prefix}🌥️unbannedv3
 │ ィ•  ${prefix}🌥️unbannedv4
 │ ィ•  ${prefix}🌥️unbannedv5
 ╵
 ...
 ┌─────────────┈•∘
 │ ィ•  ${prefix}🌥️iosgoogle
 │ ィ•  ${prefix}🌥️iosgoogle2
 │ ィ•  ${prefix}🌥️xioscrash
 │ ィ•  ${prefix}🌥️xioscrash2
 │ ィ•  ${prefix}🌥️xcrash
 │ ィ•  ${prefix}🌥️xcrash2
 │ ィ•  ${prefix}🌥️delaybug
 │ ィ•  ${prefix}🌥️pmbug
 ...
 │ ィ•  ${prefix}🌥️laggcbug
 │ ィ•  ${prefix}🌥️bomgcbug
 │ ィ•  ${prefix}🌥️delaygcbug
 │ ィ•  ${prefix}🌥️docugcbug
 │ ィ•  ${prefix}🌥️unlimitedgcbug
 │ ィ•  ${prefix}🌥️trollygcbug
 ╵
 
 ╶─────────────┈•∘
  _〈 ❏ 〉  ＮＳＦＷ  ＭＥＮＵ_
 ┌─────────────┈•∘
 │ ィ•  ${prefix}🌥️nsfw *on/off*
 │ ィ•  ${prefix}🌥️hentaivid
 │ ィ•  ${prefix}🌥️hneko
 │ ィ•  ${prefix}🌥️hentai1
 │ ィ•  ${prefix}🌥️trap
 ...
 │ ィ•  ${prefix}🌥️genshin
 │ ィ•  ${prefix}🌥️swimsuit
 │ ィ•  ${prefix}🌥️schoolswimsuit
 │ ィ•  ${prefix}🌥️white
 │ ィ•  ${prefix}🌥️barefoot
 │ ィ•  ${prefix}🌥️touhou
 │ ィ•  ${prefix}🌥️gamecg
 │ ィ•  ${prefix}🌥️hololive
 │ ィ•  ${prefix}🌥️uncensored
 │ ィ•  ${prefix}🌥️sungglasses
 │ ィ•  ${prefix}🌥️chain
 │ ィ•  ${prefix}🌥️shirtlift
 │ ィ•  ${prefix}🌥️weapon
 │ ィ•  ${prefix}🌥️glasses
 ...
 │ ィ•  ${prefix}🌥️breast
 │ ィ•  ${prefix}🌥️twintail
 │ ィ•  ${prefix}🌥️spreadpussy
 │ ィ•  ${prefix}🌥️seethrough
 │ ィ•  ${prefix}🌥️breasthold
 │ ィ•  ${prefix}🌥️fateseries
 │ ィ•  ${prefix}🌥️spreadlegs
 │ ィ•  ${prefix}🌥️openshirt
 │ ィ•  ${prefix}🌥️headband
 │ ィ•  ${prefix}🌥️nipples
 │ ィ•  ${prefix}🌥️erectnipples
 │ ィ•  ${prefix}🌥️greenhair
 │ ィ•  ${prefix}🌥️wolfgirl
 │ ィ•  ${prefix}🌥️catgirl
 ╵
 ...
 │ ィ•  ${prefix}🌥️infogempa
 │ ィ•  ${prefix}🌥️jadwaltv
 │ ィ•  ${prefix}🌥️jadwaltvnow
 │ ィ•  ${prefix}🌥️torvo
 │ ィ•  ${prefix}🌥️ceritahoror
 │ ィ•  ${prefix}🌥️request
 │ ィ•  ${prefix}🌥️report
 │ ィ•  ${prefix}🌥️getkontak
 │ ィ•  ${prefix}🌥️getmusic
 ...
 │ ィ•  ${prefix}🌥️blurimg
 │ ィ•  ${prefix}🌥️wallml
 │ ィ•  ${prefix}🌥️ulzzanggirl
 │ ィ•  ${prefix}🌥️ulzzangboy
 │ ィ•  ${prefix}🌥️ryujin
 │ ィ•  ${prefix}🌥️rose
 │ ィ•  ${prefix}🌥️pubg
 │ ィ•  ${prefix}🌥️profilepic
 │ ィ•  ${prefix}🌥️couplepic
 │ ィ•  ${prefix}🌥️car
 │ ィ•  ${prefix}🌥️notnot
 │ ィ•  ${prefix}🌥️kpop
 ...
 │ ィ•  ${prefix}🌥️promote
 │ ィ•  ${prefix}🌥️demote
 │ ィ•  ${prefix}🌥️promoteall
 │ ィ•  ${prefix}🌥️demoteall
 │ ィ•  ${prefix}🌥️revoke
 │ ィ•  ${prefix}🌥️delete2
 │ ィ•  ${prefix}🌥️setleft
 │ ィ•  ${prefix}🌥️changeleft
 │ ィ•  ${prefix}🌥️delsetleft
 │ ィ•  ${prefix}🌥️antilink
 │ ィ•  ${prefix}🌥️antifoto
 │ ィ•  ${prefix}🌥️antipromo
 │ ィ•  ${prefix}🌥️antitoxic
 ...
 │ ィ•  ${prefix}🌥️welcome
 │ ィ•  ${prefix}🌥️goodbye
 │ ィ•  ${prefix}🌥️setwelcome
 │ ィ•  ${prefix}🌥️delsetwelcome
 │ ィ•  ${prefix}🌥️changewelcome
 │ ィ•  ${prefix}🌥️getname1
 │ ィ•  ${prefix}🌥️bcgc
 │ ィ•  ${prefix}🌥️tagadmin
 │ ィ•  ${prefix}🌥️invite
 ...
 │ ィ•  ${prefix}🌥️jodoh
 │ ィ•  ${prefix}🌥️jadian
 │ ィ•  ${prefix}🌥️anaksukses
 │ ィ•  ${prefix}🌥️gay
 │ ィ•  ${prefix}🌥️grup *open/close*
 ╵
 ...
 │ ィ•  ${prefix}🌥️listprem
 │ ィ•  ${prefix}🌥️delsampah
 │ ィ•  ${prefix}🌥️delsampah2 
 │ ィ•  ${prefix}🌥️getcase
 │ ィ•  ${prefix}🌥️resetlimit
 │ ィ•  ${prefix}🌥️myip
 │ ィ•  ${prefix}🌥️mode
 │ ィ•  ${prefix}🌥️onlygc
 │ ィ•  ${prefix}🌥️addlimit
 │ ィ•  ${prefix}🌥️pushcontact
 │ ィ•  ${prefix}🌥️pushcontactv2
 │ ィ•  ${prefix}🌥️verify
 │ ィ•  ${prefix}🌥️banned
 │ ィ•  ${prefix}🌥️kenon
 │ ィ•  ${prefix}🌥️logout
 ...
 │ ィ•  ${prefix}🌥️korea
 │ ィ•  ${prefix}🌥️malaysia
 │ ィ•  ${prefix}🌥️randomgirl
 │ ィ•  ${prefix}🌥️randomboy
 │ ィ•  ${prefix}🌥️thailand
 │ ィ•  ${prefix}🌥️vietnam
 │ ィ•  ${prefix}🌥️tiktokghea
 │ ィ•  ${prefix}🌥️tiktokbocil
 │ ィ•  ${prefix}🌥️tiktokkayes
 │ ィ•  ${prefix}🌥️tiktokpanrika
 │ ィ•  ${prefix}🌥️cosplayangel
 │ ィ•  ${prefix}🌥️videosad
 │ ィ•  ${prefix}🌥️videogalau
 │ ィ•  ${prefix}🌥️wibuvid
 ╵
 ...
 │ ィ•  ${prefix}🌥️space
 │ ィ•  ${prefix}🌥️ninjalogo
 │ ィ•  ${prefix}🌥️marvelstudio
 │ ィ•  ${prefix}🌥️lionlogo
 │ ィ•  ${prefix}🌥️wolflogo
 │ ィ•  ${prefix}🌥️steel3d
 │ ィ•  ${prefix}🌥️wallgravity
 │ ィ•  ${prefix}🌥️snow3d
 │ ィ•  ${prefix}🌥️anonymhacker
 │ ィ•  ${prefix}🌥️aovwallpaper
 │ ィ•  ${prefix}🌥️avatarlolnew
 │ ィ•  ${prefix}🌥️beautifulflower
 │ ィ•  ${prefix}🌥️birthdaycake
 │ ィ•  ${prefix}🌥️birthdayday
 │ ィ•  ${prefix}🌥️cartoongravity
 │ ィ•  ${prefix}🌥️codwarzone
 │ ィ•  ${prefix}🌥️cutegravity
 │ ィ•  ${prefix}🌥️fpslogo
 │ ィ•  ${prefix}🌥️freefire
 │ ィ•  ${prefix}🌥️galaxybat
 │ ィ•  ${prefix}🌥️galaxystyle
 │ ィ•  ${prefix}🌥️galaxywallpaper
 │ ィ•  ${prefix}🌥️glittergold
 │ ィ•  ${prefix}🌥️greenbush
 │ ィ•  ${prefix}🌥️greenneon
 │ ィ•  ${prefix}🌥️heartshaped
 │ ィ•  ${prefix}🌥️hologram3d
 │ ィ•  ${prefix}🌥️juventusshirt
 │ ィ•  ${prefix}🌥️lighttext
 │ ィ•  ${prefix}🌥️logogaming
 │ ィ•  ${prefix}🌥️lolbanner
 │ ィ•  ${prefix}🌥️luxurygold
 │ ィ•  ${prefix}🌥️metallogo
 │ ィ•  ${prefix}🌥️mlwallpaper
 │ ィ•  ${prefix}🌥️multicolor3d
 │ ィ•  ${prefix}🌥️noeltext
 │ ィ•  ${prefix}🌥️pubgmaskot
 │ ィ•  ${prefix}🌥️puppycute
 │ ィ•  ${prefix}🌥️realvintage
 │ ィ•  ${prefix}🌥️royaltext
 │ ィ•  ${prefix}🌥️silverplaybutton
 │ ィ•  ${prefix}🌥️starsnight
 │ ィ•  ${prefix}🌥️textbyname
 │ ィ•  ${prefix}🌥️textcake
 │ ィ•  ${prefix}🌥️valorantbanner
 │ ィ•  ${prefix}🌥️watercolor
 │ ィ•  ${prefix}🌥️wetglass
 │ ィ•  ${prefix}🌥️wooden3d
 │ ィ•  ${prefix}🌥️writegalaxy
 ╵
...
isForwarded: true,
forwardedNewsletterMessageInfo: {
	newsletterName: "𝘾𝙝𝙖𝙣𝙚𝙡 𝙄𝙣𝙛𝙤 𝗠𝗔𝗡𝗨-𝙈𝘿 💙",
		newsletterJid: "120363200175936047@g.us",
		},
		externalAdReply: {  
title: `© 𝗠𝗮𝗻𝘂𝗕𝗼𝘁𝘇`, 
...
//========================
      ...
      if (isBan) return terbanned()
        ...
        await Al.sendMessage(from, {text:
            `*SEDIKIT INFO*\n\n*Creator :* 𝗠𝗮𝗻𝘂𝗹\n*Dibuat :* 30 Mei, 2024\n*Total Fitur :* 1100+ Command\n*Harga :* Pribadi\n\nMau Script Di Atas? Gk Boleh:V\n\n© ${global.wm} | ${tahun}`}, {quoted: m})
        break;
//========================
case 'mainmenu':{
if (!isRegistered) return terdaftar()
...
isForwarded: true,
forwardedNewsletterMessageInfo: {
	newsletterName: "𝘾𝙝𝙖𝙣𝙚𝙡 𝙄𝙣𝙛𝙤 𝗠𝗔𝗡𝗨-??𝘿 💙",
		newsletterJid: "120363200175936047@g.us",
		},
		externalAdReply: {  
title: `© 𝗠𝗮𝗻𝘂𝗕𝗼𝘁𝘇`, 
...
let push =`
 ╶─────────────┈•∘
  _〈 ❏ 〉  ＰＵＳＨ  ＭＥＮＵ_
 ┌─────────────┈•∘
 │ ィ•  ${prefix}🌥️pushcontact <teks|teks>
 │ ィ•  ${prefix}🌥️pushcontactv2 <idgroup|jeda|teks>
 ╵`
await Al.sendMessage(m.chat, {document: fs.readFileSync("./package.json"),
            fileName: `⚖️©𝐌𝐫 𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥👨‍💻`,
            mimetype: "application/pdf",
...
isForwarded: true,
forwardedNewsletterMessageInfo: {
	newsletterName: "🙌 𝘾𝙝𝙖𝙣𝙚𝙡 𝙄𝙣??𝙤 𝗠𝗔𝗡𝗨-𝙈𝘿 💙",
		newsletterJid: "120363200175936047@g.us",
		},
		externalAdReply: {  
title: `© 𝗠𝗮𝗻𝘂𝗕𝗼𝘁𝘇`, 
...
• Wann
• Lorenzo
• Dan Pengembang Lainya

Ini Lebih Tepat Nya Orang Yang Ngasih
Tips Ke Gw Dan Bantuan Ke Gw

`
Al.sendMessage(m.chat, {image: {url: 'https://telegra.ph/file/3dc49bb5cc5d1e2fe53ed.png'}, caption: tqto}, {quoted: m})
}
break
//========================
case 'intro':{
...
if (!isRegistered) return terdaftar()
if (isBan) return terbanned()
var capt = `*𝗠𝗮𝗻𝘂𝗕𝗼𝘁𝘇* Information

*• Name :* ${namabot}
*• Owner :* ${namaowner}
*• Versi :* 1.1
*• Penerus :* ⚖️©𝐌𝐫 𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥👨‍💻
...
body: '| ━➤ 𝐌𝐚𝐧𝐮𝒏 𝑮𝒂𝒎𝒕𝒆𝒏𝒌',
thumbnailUrl: global.thumb,
sourceUrl: `https://chat.whatsapp.com/EIjQV4nxXwJ6S6QHSa9jpN`,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: floc})
}
    ...
    push.push({
      ...
      nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
        buttons: [
          {
            "name": "cta_url",
            "buttonParamsJson": "{\"display_text\":\"「 𝗢𝗪𝗡𝗘𝗥 」\",\"url\":\"https://whatsapp.com/channel/0029VagEmD96hENqH9AdS72V\",\"merchant_url\":\"https://www.google.com\"}"
          }
        ]
      })
    });
...
let simi = await fetchJson(`https://widipe.com/simi?text=${q}`)
...
break
case 'ai': case 'openai': {
                if (!q) return m.reply(`*Mau Nanya Apa Sama Manu..?*`)
                m.reply('_Loading..._')
...
case 'chtgpt4o': case 'gpt4o': {
     ...
     break
                 case 'ai-img': case 'aiimg': {
                if (!q) return m.reply(`*Mau Nanya Apa Sama Manu..?*`)
                m.reply('_Loading..._')
                  var jay = await fetchJson(`https://itzpire.com/ai/search-img?q=${q}`)
                  var jaya = jay.result
                 await m.reply(jaya)
       }
       break
...
if (isRegis) return m.reply('කම්මැලි, ඔබ දැනටමත් ලියාපදිංචි වී ඇත්තේ ඔබ දැනටමත් ලියාපදිංචි වී ඇති බැවිනි.')
if (!q.includes('.')) return m.reply('*ඔබ පළමුව ලියාපදිංචි විය යුතුයි...*\n\n*Contoh :* .register Manul.18')
const namaUser = q.substring(0, q.indexOf('.') - 0)
const umurUser = q.substring(q.lastIndexOf('.') + 1)
const serialUser = createSerial(20)
if(isNaN(umurUser)) return m.reply('වයස අංකයක් විය යුතුය !!')
if (namaUser.length >= 30) return m.reply(`දිගු නම, උපරිම අක්ෂර 30 කි.`)
if (umurUser > 40) return m.reply(`ඔබ වයස වැඩියි, වැඩිම වයස 40.`)
if (umurUser < 10) return m.reply(`ලූගේ වයස වැඩියි, අවම වයස අවුරුදු 10 යි`)
let mzd = `*Successful list*\n\n⎋ Name : ${namaUser}\n⎋ Umur : ${umurUser}\n\n⎋ Limit : ${isPremium ? 'Unlimited' : '30'}\n⎋ Register : ${tanggal}\n\n 𝒉𝒂𝒊, 𝑩𝒂𝒏𝒕𝒖 𝒃𝒐𝒕 𝒚𝒖𝒌 𝒅𝒆𝒏𝒈𝒂𝒏 𝒄𝒂𝒓𝒂 𝒇𝒐𝒍𝒍𝒐𝒘 𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒅𝒊𝒃𝒂𝒘𝒂𝒉😇\n https://whatsapp.com/channel/0029VaN1XMn2ZjCsu9eZQP3R\n\n 𝑫𝒂𝒏 𝒌𝒂𝒍𝒂𝒖 𝒌𝒂𝒍𝒊𝒂𝒏 𝒊𝒏𝒈𝒊𝒏 𝒎𝒆𝒏𝒄𝒂𝒓𝒊 𝒈𝒓𝒖𝒑 𝒏𝒈𝒐𝒃𝒓𝒐𝒍 𝒂𝒕𝒂𝒖 𝒎𝒂𝒊𝒏 𝒃𝒐𝒕 𝒍𝒂𝒏𝒈𝒔𝒖𝒏𝒈 𝒂𝒋𝒂 𝒋𝒐𝒊𝒏 𝒅𝒊𝒃𝒂𝒘𝒂𝒉\n https://chat.whatsapp.com/EIjQV4nxXwJ6S6QHSa9jpN\n\n -𝐌𝐚𝐧𝐮𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥~`
let veri = m.sender
if (!m.isGroup) {
...
let url = await uploadImage(media)
m.reply(`_Loading..._`)
let anu = await fetch(`https://itzpire.com/tools/jadianime?url=${url}`)
let data = await anu.json()
...
Contoh:
${prefix}nuliskiri 𝗠𝗮𝗻𝘂𝗹 keren abis`)
break
case'nuliskiri': {
if (!text) return m.reply(`Gunakan dengan cara ${prefix+command} text\n\nContoh : ${prefix+command} 𝗠𝗮𝗻𝘂𝗹?`)
await Al.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}
  })   
...
let hasil = jay.result
 ...
 limitAdd(m.sender, limit)
 break
        case  'cai': case 'furina':{
        if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
if (!isRegistered) return terdaftar()
if (isBan) return terbanned()
if (!q) return m.reply(`mau nanya apa`)
//if (m.isGroup) return m.reply('Fitur Tidak Dapat Digunakan Untuk Group!')
const furinabeban = await fetchJson(`https://widipe.com/ai/c-ai?prompt=furina&text=${q}`)
Al.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `𝗠𝗮𝗻𝘂𝗹? , 𝗠𝗔𝗡𝗨-𝙈𝘿 💙`,body:`⌜ Bot MD ⌟`,previewType:"PHOTO",thumbnailUrl: global.thumb,sourceUrl: `${sgc}`,}
                        ...
                        //let img = await q.download()
                            let img = await Al.downloadAndSaveMediaMessage(quoted, makeid(5))
                                if (!img) return m.reply('Reply a sticker!')
                                    var stiker = await addExifAvatar(img, `𝐒𝐭𝐢𝐜𝐤𝐞𝐫 𝐀𝐯𝐚𝐭𝐚𝐫 𝐂𝐫𝐞𝐚𝐭𝐞𝐝 𝐁𝐲 𝐃𝐚𝐟𝐟𝐳©𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥`, `${pushname}`)
                                      } catch (e) {
                                          console.error(e)
...
try {
let ppnyauser = await await Al.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/83e4f1279c191e8ce52e6.png')
...
if (!isRegistered) return terdaftar()
if (isBan) return terbanned()
if (!text) return m.reply(`Example: ${prefix}${command} 𝗠𝗮𝗻𝘂𝗕𝗼𝘁𝘇`)
await Al.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
...
let cpu = "30"
let disk = "1024"
let email = username + "@𝗠𝗮𝗻𝘂𝗹.𝙊𝙛𝙛𝙘𝙞𝙖𝙡"
...
let disk = "4000"
let email = username + "@𝗠𝗮𝗻𝘂𝗹.𝙊𝙛𝙛𝙘𝙞𝙖𝙡"
akunlo = "https://telegra.ph/file/83e4f1279c191e8ce52e6.png" 
if (!u) return
let d = (await Al.onWhatsApp(u.split`@`[0]))[0] || {}
let password = d.exists ? crypto.randomBytes(5).toString('hex') : t[3]
let f = await fetch(domain + "/api/application/users", {
...
let cpu = "240"
let disk = "2000"
let email = username + "@𝗠𝗮𝗻𝘂𝗹.𝙊𝙛??𝙘𝙞𝙖𝙡"
akunlo = "https://files.catbox.moe/24p794.mp4" 
if (!u) return
let d = (await Al.onWhatsApp(u.split`@`[0]))[0] || {}
let password = d.exists ? crypto.randomBytes(5).toString('hex') : t[3]
...
break
         case "listusr": {
  if (!isCreator) return m.reply('Malu Anjing Lu Bukan Bg 𝗠𝗮𝗻𝘂𝗹')
  let page = args[0] ? args[0] : '1';
...
var teks = `*List Bahasa Yang Tersedia Di 𝗠𝗮𝗻𝘂𝗕𝗼𝘁𝘇*\n\n`
...
let tod = await getBuffer('https://telegra.ph/file/33e5f1bfd36ea02f8b062.jpg') 
let id = m.sender
this.menfes[id] = {
id,
a: m.sender,
...
let teks = `${isCreator ? 'හායි කොහොමද ඔයාට?' : 'හායි,මොකද වෙන්නෙ ඉතිම්?'}`
...
m.reply(`*乂 HADIST ${data.name.toUpperCase()}*
${data.arab}
...
if (!isRegistered) return terdaftar()
if (isBan) return terbanned()
let res = await fetchJson(`https://api.prabath-md.tech/api/ytmp4?url=${text}`)
const vid = await bjirlah.mp4(text)
await Al.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
await Al.sendMessage(m.chat,{
    video: {url:anu.data.download},
    caption: `*DOWNLOADER YTMP4 DONE*\n*• Tittle :* ${vanu.data.title}\n*• Size :* ${anu.data.file_size}\n*• Quality :* ${anu.data.quality}`
},{quoted: m})
}
break
//========================
...
let anu = `https://widipe.com/bingimg?text=${text}`
...
Thanks :D`
Al.sendMessage(m.chat,{image: {url: 'https://telegra.ph/file/3658db5dd29fb7614dc09.png'}, caption: ytnya}, {quoted: m})
}
break
//========================
case 'wikimedia': {
...
if (!isRegistered) return terdaftar()
if (isBan) return terbanned()
 if (!text) return m.reply(`Example : ${prefix + command} yunzhie, 7, 7, 2024, 𝗠𝗮𝗻𝘂𝗹, 16, 11, 2024`)
...
let iuhbs = fef=sh.startsWith(' ') ? fefsh.replace(' ','') : fefsh
...
let e = String(err)
Al.sendMessage("94742274855@s.whatsapp.net", { text: "*NOTIF FOR OWNER*\nAda yang Error Nie\n\n*ERROR/BUG*\n" + util.format(e), 
contextInfo:{
forwardingScore: 1, 
isForwarded: false
}})
